 ...
 */
public class ClassStuListData {

    /**
     *   学生名单
     */
    private List<ClassStuInfo> students;
    ...
    /**
     * 不同选课状态（重修，自修，在修，正常）对应的人数
     */
    private Map<String,Integer>numberOfXkzt;

    /**
     * 不同专业下不同班级对应的人数。
     */
    private Map<String,Map<String,Integer>> numberOfZyAndBj;

    /**
     * 正常选课的专业和班级人数
     */
    private Map<String,Map<String,Integer>> numberOfNormalBj;
